    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header header-elements-inline">
                <h3 class="card-title just-centent-center">درج معلومات متقاضیان</h3>
            </div>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control" name="firstname" required="this is required">
                        @error('firstname')
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control"name="firstnameEn" required>
                        @error('firstnameEn')
                        <p class="alert alert-danger mt-1">
                            {{$message}}
                        </p>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <span class="text-danger">*</span></label>
                        <input type="text" class="form-control"name="lastnameEn" required>
                        @error('lastnameEn')
                        <p class="alert alert-danger mt-1">
                            {{$message}}
                        </p>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <span class="text-danger">*</span></label>
                        <input type="text" class="form-control"name="fathernameEn" required>
                        @error('fathernameEn')
                        <p class="alert alert-danger mt-1">
                            {{$message}}
                        </p>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="grandfathernameEn" required>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control"name="eyecolorEn">
                        @error('eyecolorEn')
                        <p class="alert alert-danger mt-1">
                            {{$message}}
                        </p>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control"name="skincolorEn">
                        @error('skincolorEn')
                        <p class="alert alert-danger mt-1">
                            {{$message}}
                        </p>
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control"name="otherIdent">
                        @error('otherIdent')
                        <p class="alert alert-danger mt-1">
                            {{$message}}
                        </p>
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control"name="otherIdentEn">
                        @error('otherIdentEn')
                        <p class="alert alert-danger mt-1">
                            {{$message}}
                        </p>
